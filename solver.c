...
void getSol1x1(Solver* solver) { //solution for matrix 1x1
	solver->X_Vec[0] = solver->B_Vec[0] / solver->A_Mat[0][0];
	printf("Vector x=\n		%.3f", solver->X_Vec[0]);

}

void getSol2x2(Solver* solver) { //solution for matrix 2x2
...
void getSol3x3(Solver* solver) { //solution for matrix 3x3
